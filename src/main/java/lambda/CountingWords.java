...
public class CountingWords {
  ...
  public static void method() {
    ...
    try {
      stream =
          Files.lines(Paths.get("/home/sergiogp/eclipse-workspace/Test/src/lambda/hitch2.txt"));
      ...
      Stream<Map.Entry<String, Long>> result =
          o.entrySet().stream().sorted((o1, o2) -> o2.getValue().compareTo(o1.getValue()));
          ...
          stream
              ...
              reduce(
                  ...
                  (accumulator, e) -> {
                    accumulator.put(
                        e.getKey(),
                        accumulator.get(e.getKey()) == null ? 1 : accumulator.get(e.getKey()) + 1);
      ...
      // System.out.println(o);
      result = o.entrySet().stream().sorted((o1, o2) -> o2.getValue().compareTo(o1.getValue()));
