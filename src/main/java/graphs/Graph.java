...
public class Graph {
   ...
   *
   * @return the number of vertices <em>intNumberOfVertices</em>, followed by the number of edges
   *     <em>intNumberOfEdges</em>, followed by the <em>intNumberOfVertices</em> adjacency lists
   */
