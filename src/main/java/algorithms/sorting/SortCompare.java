...
/**
 * **************************************************************************** Compilation: javac
 * SortCompare.java Execution: java SortCompare alg1 alg2 n trials Dependencies: StdOut.java
 * Stopwatch.java
 *
 * <p>Sort n random real numbers, trials times using the two algorithms specified on the command
 * line.
 *
 * <p>% java SortCompare Insertion Selection 1000 100 For 1000 random Doubles Insertion is 1.7 times
 * faster than Selection
 *
 * <p>Note: this program is designed to compare two sorting algorithms with roughly the same order
 * of growth, e,g., insertion sort vs. selection sort or mergesort vs. quicksort. Otherwise, various
 * system effects (such as just-in-time compiliation) may have a significant effect. One alternative
 * is to execute with "java -Xint", which forces the JVM to use interpreted execution mode only.
 *
 * <p>****************************************************************************
 */
