...
// static<T>void parEach(TaggedArray<T>a,Consumer<T>action){Spliterator<T>s=a.spliterator();long
// targetBatchSize=s.estimateSize()/(ForkJoinPool.getCommonPoolParallelism()*8);new
// ParEach(null,s,action,targetBatchSize).invoke();}
