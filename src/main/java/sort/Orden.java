...
/**
 * Dado un arreglo A=[9,4,7,2,1,6,...] este arreglo define un orden, asi que dado cualquier otro
 * arreglo este ultimo se debe ordenar de acuerdo al orden definido en A
 */
public class Orden {
