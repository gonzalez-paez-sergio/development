...
public class NestedOuterClass {
	...
	static class StaticNestedInnerClass {
		...
		public void method() {
			...
			System.out.println("StaticNestedInnerClass.method " 
			+ "\n\tprivateStaticFinal:" + privateStaticFinal
					+ "\n\tpublicStaticFinal:" + publicStaticFinal 
					+ "\n\tprivateStatic:" + privateStatic++
					+ "\n\tpublicStaticl:" + publicStatic++ 
					+ parentStaticMethod()
		...
		public static void staticMethod() {
			// we can access only to the static variables, public and private
			System.out.println("StaticNestedInnerClass.staticMethod " 
			+ "\n\tprivateStaticFinal:" + privateStaticFinal
					+ "\n\tpublicStaticFinal:" + publicStaticFinal 
					+ "\n\tprivateStatic:" + privateStatic++
					+ "\n\tpublicStaticl:" + publicStatic++ 
	...
	public  class NestedInnerClass {
		...
		public void method(StaticNestedInnerInterface staticNestedInnerInterface) {
			System.out.println("INSIDE METHOD StaticNestedInnerInterface:" + staticNestedInnerInterface.getStringFromInterface());	
	...
	public static void main(String... strings) {
		...
		nestedInnerClass.method(new NestedOuterClass.StaticNestedInnerInterface() {
