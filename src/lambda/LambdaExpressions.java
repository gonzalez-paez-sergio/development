...
public class LambdaExpressions {
	...
	public static void main(String... string) {
		...
		Person p = new Person(18, "Chaps18", LocalDate.of(2017, 12, 25), Person.Sex.MALE, "test18@gmail.com");
		listPerson.add(p);
		...
		lambdaExpressions.printPerson(listPerson, new CheckPersons() {
		...
		lambdaExpressions.printPerson(listPerson,
		...
		lambdaExpressions.processPersonsWithFunctions(listPerson, person -> person.getGender().equals(Person.Sex.MALE),
				email -> System.out.println(email), person -> person.getEmailAddress());
		...
		lambdaExpressions.processPersonsWithFunctionsGenerics(
				...
				person.getGender().equals(Person.Sex.MALE) && person.getAge() == 18
...
//		Arrays.sort(arrayPerson, (a,b) ->a.compareByAgeNonStatic(b));
		...
		Supplier<Person> c = () -> {return new Person();};
		
		System.out.println(c + "-"+c.get());

	
		Set<Person> setPerson = Transfer(
	...
	public static <T, 
	K extends Collection<T>, 
	V extends Collection<T>> V Transfer(
	...
	private void testLambdaScope(List<Person> listPerson) {
		this.privateInt = 45;
		listPerson.stream().filter(person -> {
			return person.getGender().equals(Person.Sex.MALE) && person.getAge() > this.privateInt;
	...
	private void processPersonsWithFunctions(List<Person> listPerson, Predicate<Person> predicatePerson,
			Consumer<String> consumerPerson, Function<Person, String> functionPerson) {
	...
	public void processPersons(List<Person> listPerson, Predicate<Person> predicatePerson,
			Consumer<Person> consumerPerson) {
...
class Person {
	...
	public void printPerson(String string) {
		...
		System.out.println(string + "-Person [age=" + age + ", name=" + name + ", birthday=" + birthday + ", gender="
	...
	public String toString() {
		return "Person [age=" + age + ", name=" + name + ", birthday=" + birthday + ", gender=" + gender
