...
public class DinamicArray {
	...
	public static void evaluate(String stringLine){
		...
		if (stringOperation.equals("1")){
			findSequence1(Integer.parseInt(stringArray[1]),Integer.parseInt(stringArray[2]));
		}
		if (stringOperation.equals("2")){
			findSequence2(Integer.parseInt(stringArray[1]),Integer.parseInt(stringArray[2]));
		}
	}
