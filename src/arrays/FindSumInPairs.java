...
/**
 * given an array of integer and a target, write a function to return all the
 * pairs that have summations equals to the target
 * 
 * @author sergiogp
 *
 */
...
//			System.out.printf("intTarget=%d, resultIndex=%d, i=%d,current value=%d, searchingfor=%d\n", intTarget,
